package io.github.maodua.user.util;
...
public class TokenUtil implements Serializable {
    ...
    public final static long shortDuration = 2 * 60 * 60;
    public final static long longDuration = 30 * 24 * 60 * 60;
    /**
     * 创建token
     *
     * @param
    ...
    public static String create(boolean isShort, String userId) {
        ...
        LocalDateTime time = isShort ? LocalDateTime.now().plusSeconds(shortDuration) : LocalDateTime.now().plusSeconds(longDuration);
        // Token中存储的信息
        return JWT.create()
